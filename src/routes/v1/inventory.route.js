...
router
  ...
  .get(auth('manageInventory'), validate(inventoryValidation.getInventories), inventoryController.getInventories);

router
  .route('/:inventoryId')
  .get(auth('manageInventory'), validate(inventoryValidation.getInventory), inventoryController.getInventory)
